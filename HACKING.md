...
| TRUST_ENV_PROXY | boolean value, support for connection with Dynatrace via proxy, if true proxies information is getting from HTTP_PROXY / HTTPS_PROXY environment variables |
